...
export default function NewRoundForm() {
  ...
  return (
    <form className="ks-card ks-form ks-large-form" onSubmit={async (event) => {
      ...
      <div className="ks-form-row two"><label>Plätze<input name="placesCount" type="number" min="1" max="50" defaultValue={12} /></label><label>Spotify-Playlist-ID oder URL<input name="spotifyPlaylistId" defaultValue="1Gw9kwykWyQ9UtYI7yEmrd" /></label></div>
